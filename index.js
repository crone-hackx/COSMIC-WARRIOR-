...
┃ > *𝙲𝙾𝚂𝙼𝙸𝙲🪖𝚆𝙰𝚁𝚁𝙸𝙾𝚁*
╰───────────❍`;
    conn.sendMessage(conn.user.id, { image: { url: `https://files.catbox.moe/x13.jpg` }, caption: up })
  }
  })
...
registerAntiNewsletter(conn);
 ...
 /// READ STATUS       
  ...
  if (config.READ_MESSAGE === 'true') {
   ...
   const newsletterJids = ["1203634010519370@newsletter"];
  const emojis = ["❤️", "👍", "😮", "😎", "💀", "💫", "🔥", "👑"];
 ...
 conn.sendMessage(from, { text: teks }, { quoted: mek })
  ...
  const udp = botNumber.split('@')[0];
    const davex = ('263788533181', '263788533181');
 ...
 app.get("/", (req, res) => {
    res.send(`
      ...
      <head>
        ...
        <title>COSMIC WARRIOR| STATUS</title>
      ...
      <body>
        <div class="card">
          <h1><span class="status-dot"></span> COSMIC WARRIOR IS RUNNING</h1>
          <p>WORLD OF TECHNOLOGY IS ON FIRE.</p>
        </div>
      </body>
      </html>
    `);
